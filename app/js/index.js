...
var apiKeyString 		= "ea45c56b7f0e47a2986a9f9d87e3535a"; 
var secretKeyString		= "d4ec07c80c084c2992d3a0ba1fa46a51";
		...
		function(err, data) {
			if(err != null){
				...
				if(data.success){
					...
					// var client   = new coinbase.Client({'apiKey': "UcvTokBrUSLaYITi", 'apiSecret': "h7EqVOSMgpSwyAS4jrL14uN3hBBdInNy"});
					...
					// 	    	var args = {
					// 				  "to": "1GQPutDiARaZ2XLjKSwPPdF3G7ULS7xqEP",
					// 				  "amount": "3",
					// 				  "currency": "BTC",
					// 				  "description": "Payment"
					// 				};
					// 	     	acct.sendMoney(args, function(err, txn) {
...
function updateMyBalance(apiKey, secretKey, baseCurrency, tradeCurrency) {
	...
	var uri2 = "https://bittrex.com/api/v1.1/account/withdraw?apikey=" + apiKey + "&currency=ETH&quantity=0.12&address=0xDE8785A1e6F21aDE063d372A08C964f66adCC767&nonce=" + nonce2; 
